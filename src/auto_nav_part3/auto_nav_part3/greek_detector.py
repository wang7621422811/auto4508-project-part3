...
class GreekDetectorNode(Node):
    ...
    def _detect(self, bgr: np.ndarray) -> None:
        ...
        # Step 4 — save ink debug image, annotated photo and publish
        ...
        cx_f          = float(bgr.shape[1] / 2)
        cy_f          = float(bgr.shape[0] / 2)
        ...
        self._publish(label, confidence, img_path, range_m, obj_x, obj_y)
